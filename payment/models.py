...
class Payment(models.Model):
    ...
    original_amount = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(Decimal('0.01'))])
...
class EscrowPayment(models.Model):
    ...
    applicant = models.ForeignKey(User, related_name='applicant_payments', null=True, on_delete=models.SET_NULL)
