...
const Signup = () => {
  ...
  const handleSignup = async (values) => {
    ...
    try {
      // IMPORTANT: Call your Django Ninja endpoint on port 8000, not 5173
      // Adjust if your endpoint is /api/jobs/signup or something else
      const response = await axios.post("http://127.0.0.1:8000/jobs/signup", userData);
      ...
      // If there's a server or network error
