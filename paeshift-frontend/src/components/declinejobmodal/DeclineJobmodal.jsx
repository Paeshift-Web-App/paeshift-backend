...
const DeclineJobmodal = () => {
    ...
    return (
        <div className="modal fade come-from-modal right text-center" id="declineJobmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body mb-0 pb-0">
                        ...
                        <div className="title">
                            <h1>Successful!</h1>
                            <p>You’ve successfully declined this applicant to take on this job. You can proceed to check other applicant to consider</p>
                        </div>
                        ...
                        <div className="row m-0 p-0">
                            ...
                            <div className="col-8">
                                <button type="submit" className="btn proceed-btn" data-bs-toggle="modal" data-bs-target="#paymentMethodModal" >Back to All Applicant</button>
