...
const Notificationmodal = () => {
    ...
    useEffect(() => {
        Axios.get("http://localhost:8000/api/notifications/notifications/")
            .then((response) => {
    ...
    const handleReadNotification = () => {
        useEffect(() => {
            Axios.post("http://localhost:8000/api/notifications/notifications/{notification_id}/mark-as-read/")
                .then((response) => {
                    setJobs(response.data.jobs);
                    console.log(response.data.jobs);
                })
