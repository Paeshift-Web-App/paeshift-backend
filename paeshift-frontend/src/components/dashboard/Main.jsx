...
const Main = () => {
  ...
  let [savedJob, setSavedJob] = useState("");
  ...
  const saveJob = (e) => {
    ...
    setSavedJob(val);
    useEffect(() => {
      Axios.get("http://localhost:8000/jobs/saved-jobs/add/")
        .then((response) => {
                ...
                <div className="card" key={key}>
                  <div className="card_top">
                    ...
                    <span className="top_cta">
                      <button className={savedJob === 1 ? "btn active" : "btn"} onClick={() => saveJob()}>Saved &nbsp; <FontAwesomeIcon icon={faBookmark} className="icon-saved" /> </button>
                    </span>
                  </div>
