...
// All Notification 
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Form Data:", formData); // Log input values
    useEffect(() => {
     Axios.put("http://localhost:8000/api/notifications/notifications/settings/", {formData})
       .then((response) => {
 ...
 useEffect(() => {
  Axios.get("http://localhost:8000/api/notifications/notifications/settings/")
    .then((response) => {
      // setSavedJobs(response.data);
      console.log(response);
    })
  ...
  // REMOVES SAVED JOBS 
  const removeSavedJob = (job_id) => {
    useEffect(() => {
      // Axios.delete(`http://localhost:8000/jobs/save-job/.${job_id}`)
      Axios.delete(`http://localhost:8000/jobs/saved-jobs/delete/${job_id}/`)
        .then((response) => {
          console.log(response.data);
        })
        .catch((error) => console.error(error));
        ...
        <div className="row m-0 p-md-2 px-md-2">
          ...
          <div className={showSlide === 0 ? "animate__animated animate__fadeIn col-12 col-md-8 col-xl-9 m-0  p-2 py-3 profile_form" : "col-12 col-md-8 col-xl-9 m-0 px-0 profile_form hide"}>
           ...
           <div className={activeTab === 1 ? "animate__animated animate__fadeInRight tab-content display" : "tab-content"} id="profile">
              ...
              <input type="file" id="changeimage" className="imagefile" placeholder="Change Image" />
                  ...
                  <Form className="edit_profile_form">
                    <div className="row form_row">
                      ...
                      <div className="col-12 email">
                        ...
                        <Field name="email" className="form-control" placeholder="example@gmail.com" />
                      ...
                      <div className="card" key={key}>
                        <div className="card_top">
                          ...
                          <span className="top_cta">
                            <button className="btn active" onClick={() => removeSavedJob(key)}>Remove &nbsp; <FontAwesomeIcon icon={faCircleXmark} className="icon-saved" /> </button>
                          </span>
                        </div>
              ...
              <form onSubmit={handleSubmit} className="notification_form">
                <div className="row notifications">
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="newjob" type="checkbox" role="switch" id="notify-switch"
                  ...
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="newjobreminder" type="checkbox" role="switch" id="notify-switch1"
                        onChange={handleChange} />
                    </div>
                  </div>
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="jobrequest" type="checkbox" role="switch" id="notify-switch2"
                        onChange={handleChange} />
                    </div>
                  </div>
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="settings" type="checkbox" role="switch" id="notify-switch3" defaultChecked
                        onChange={handleChange} />
                    </div>
                  </div>
                </div>
                ...
                <div className="row notifications">
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="emailnewjob" type="checkbox" role="switch" id="notify-switch4"
                        onChange={handleChange} />
                    </div>
                  </div>
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="emailjobreminder" type="checkbox" role="switch" id="notify-switch5" defaultChecked
                        onChange={handleChange} />
                    </div>
                  </div>
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="jobacceptance" type="checkbox" role="switch" id="notify-switch6"
                        onChange={handleChange} />
                    </div>
                  </div>
                  <div className="col-12 notification">
                    ...
                    <div className="form-check form-switch">
                      <input className="form-check-input" name="emailsettings" type="checkbox" role="switch" id="notify-switch7" defaultChecked
                        onChange={handleChange} />
                    </div>
                  </div>
                </div>
                ...
                <div className="col-12">
                  ...
                  <Formik
                    ...
                    onSubmit={async (values, { setSubmitting }) => {
                      ...
                      useEffect(() => {
                        Axios.post("http://localhost:8000/disputes/submit/", {userData})
                          .then((response) => {
                            // setSavedJobs(response.data);
                            console.log(response);
                          })
