...
const ApplicantProfilemodal = () => {
  ...
  return (
    <div className="modal fade come-from-modal right" id="applicantProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div className="modal-content">
          ...
          <div className="modal-body py-0">
              ...
              <div className="row">
                <div className="col-12 text-center">
                  ...
                  <span className="profile_details mt-1">
                    <h4>Jasminxx</h4>
                    <img src={Stars} alt="profile" /> <span className="rate_score">4.99</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="row tabs m-0 p-0">
              <ul >
                <li className={toggle === 1 ? "profile-btn active" : "profile-btn"} onClick={() => updateToggle(1)}>Jobs Taken</li>
                  ...
                  return (
                    <div className="card" key={key}>
                      ...
                      <div className="price">
                        ...
                        <span>
                          <Link to="../jobdetails" className="btn">Completed</Link>
                        </span>
                      </div>
                    </div>
                  )
            ...
            <div className="row m-0 p-0 bg-white">
              <div className="col-4 px-1">
                <button type="button" name='submit' className="btn preview-btn"  data-bs-toggle="modal" data-bs-target="#declineJobmodal"      >Decline</button>
              </div>
              <div className="col-8">
                <button type="submit" className="btn proceed-btn" data-bs-toggle="modal" data-bs-target="#acceptJobConfirmModal" >Accept Applicant</button>
              </div>
            </div>
          </div>
        </div>
