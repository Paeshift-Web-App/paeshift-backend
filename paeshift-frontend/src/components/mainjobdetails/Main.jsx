...
const Main = () => {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:8000//jobs/${job_id}`)
    .then(
      (response) => {
        console.log(response.data);
  ...
  // ✔️ **POST** `/api/tracker/update-location/` → Update Location  
  // ✔️ **GET** `/api/tracker/track-applicant/{applicant_id}/` → Track Applicant  
  // ✔️ **POST** `/api/tracker/jobs/{job_id}/update-location/` → Update Job Location  
  // ✔️ **GET** `/api/tracker/jobs/{job_id}/best-applicants/` → Get Best Applicants  
  ...
  //   Axios.get("http://localhost:8000/api/tracker/track-applicant/{applicant_id}/")
  //     .then((response) => {
  ...
  //   Axios.post("http://localhost:8000//api/tracker/update-location/")
  //     .then((response) => {
  //       setAdmins(response.data);
  //     })
  //     .catch((error) => console.error(error));

  //   Axios.get("http://localhost:8000//api/tracker/jobs/{job_id}/best-applicants/")
  //     .then((response) => {
