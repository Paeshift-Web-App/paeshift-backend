...
SECRET_KEY = 'django-insecure-44afb38xx*axsoymn_2u4hgq)r#12()*xp&ngc#2h6&0!okxw='
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "PaeShift Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "PaeShift",
    ...
    "welcome_sign": "Welcome to PaeShift",
    ...
    "search_model": ["authUser.CustomUser", "authUser.Group"],
   ...
   "order_with_respect_to": ["authUser", "authUser.CustomUser", "authUser.Profile"],
